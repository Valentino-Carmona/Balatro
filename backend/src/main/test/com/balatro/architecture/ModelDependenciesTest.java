package com.balatro.architecture;
...
public class ModelDependenciesTest {
    ...
    @org.junit.jupiter.api.Disabled("Fails on synthetic switch map arrays")
    @Test
    public void elModeloSoloPuedeReferenciarClasesDelModeloAdemasJavaAdemasJunit() {
        JavaClasses importedClasses = new ClassFileImporter().importPackages("com.balatro.modelo");

        String[] listOfPackages = {MODEL, JAVA_LANG, JUNIT, JACKSON, DTO};
